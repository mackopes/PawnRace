#ifndef MINIMAXPLAYER_EXPERIMENTAL_H
#define MINIMAXPLAYER_EXPERIMENTAL_H
...
class Minimax_Player_Experimental : public Player {
 private:
  struct llboard {
    ll attacker;
    ll deffender;
 ...
 public:
  Minimax_Player_Experimental(tile color);
  Minimax_Player_Experimental(tile color, long max_time);
  Move get_move(Board board);
  virtual ~Minimax_Player_Experimental() {
    //empty
  }
};
